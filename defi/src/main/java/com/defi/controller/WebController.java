...
public class WebController {
    ...
    public String showMyLoans(Model model, Authentication authentication) {
        if (authentication != null) {
            ...
            // Get loans excluding current user's own loan requests
            List<Loan> availableLoans = loanService.getLoanHistoryForUser(email,"requested");
            model.addAttribute("loans", availableLoans);
    ...
    @GetMapping("/accepted_loans")
    public String showMyLoansAccepted(Model model, Authentication authentication) {
        if (authentication != null) {
            String email = authentication.getName();
            
            // Get loans excluding current user's own loan requests
            List<Loan> availableLoans = loanService.getLoanHistoryForUser(email,"accept");
            model.addAttribute("loans", availableLoans);
